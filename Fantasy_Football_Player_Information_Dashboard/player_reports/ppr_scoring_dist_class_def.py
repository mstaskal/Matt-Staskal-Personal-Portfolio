...
Topic: Fantasy football player dashboard - Scoring distribution report class definitions
...
***There are many unnecessary class attributes created in these definitions. Would like to go back and refine the csv file and definitions
to eliminate unnecessary attributes that aren't used in the report.***
"""
